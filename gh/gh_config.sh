...
if [ ${FZFLET_GITHUB_CONFIG:-0} -eq 0 ]; then
    ...
    export FZFLET_GITHUB_SEARCH_PULLS_QUERY=`envsubst <<< $FZFLET_GITHUB_SEARCH_PULLS_QUERY`
    export FZFLET_GITHUB_SEARCH_PULLS_REVIEW_REQUESTED_QUERY=`envsubst <<< $FZFLET_GITHUB_SEARCH_PULLS_REVIEW_REQUESTED_QUERY`
    export FZFLET_GITHUB_SEARCH_PULLS_CREATED_QUERY=`envsubst <<< $FZFLET_GITHUB_SEARCH_PULLS_CREATED_QUERY`
    ...
    export FZFLET_GITHUB_OPEN_PULL_KEY=${FZFLET_GITHUB_OPEN_PULL_KEY:-$(eval echo "\${FZFLET_GITHUB_${FZFLET_GITHUB_CONTEXT}_OPEN_PULL_KEY:-enter}")}
